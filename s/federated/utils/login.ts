...
import {VerificationOptions} from "../../auth/utils/json-web-token.js"
...
export class Login {
	...
	static async verify(tokens: LoginTokens, options?: VerificationOptions) {
	...
	get expiry() { return this.proof.expiry }
