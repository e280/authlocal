...
export const EgressPage = nexus.shadowView(use => (situation: Situation.Egress) => {
	...
	return html`
		<section>
			...
			<p>You can upload your identities to multiple devices. Never lose your identity files, and never share them with others. Once lost or compromised, identities are impossible to recover.</p>
		</section>
