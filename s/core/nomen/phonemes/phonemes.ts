...
export const prefixes = new Phonemes([
	"nop", "bem", "bin", "bor", "buf", "cal", "cem", "cin", "cor", "cub", "dal", "dem", "din", "dor", "dul", "fal",
	...
	"sun", "tal", "tem", "tin", "tor", "tul", "val", "vem", "vin", "vor", "vul", "wel", "wem", "win", "wor", "xal",
	...
	"hur", "jar", "jel", "jol", "jur", "kar", "kel", "kol", "kur", "lar", "lel", "lol", "lur", "mar", "mel", "mol",
	"mur", "nar", "nel", "nol", "nur", "par", "pel", "pol", "pur", "rar", "rel", "rol", "rur", "sar", "sel", "sol",
	"sur", "tar", "tel", "tol", "tur", "var", "vel", "vol", "vur", "war", "wol", "wur", "yar", "yel", "yol", "yur",
...
export const suffixes = new Phonemes([
	"nop", "ryx", "rux", "rak", "ruk", "rad", "ren", "ryd", "zex", "zyx", "zok", "zak", "zud", "zen", "zyn", "xel",
	...
	"vek", "vex", "vyr", "vox", "wex", "wyn", "wyr", "wux", "yak", "yex", "yod", "yux", "zor", "zyl", "bar", "bex",
	...
	"nok", "pek", "pok", "rek", "rok", "sek", "sok", "tak", "tok", "vak", "vok", "wak", "wek", "wok", "yek", "yok",
	...
	"nyd", "pyd", "tyd", "vyn", "zek", "byn", "dyn", "fyn", "gen", "lyn", "nyn", "ryn", "syn", "tyn", "myl", "nyl",
